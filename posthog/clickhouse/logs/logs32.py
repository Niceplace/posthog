...
LOGS_DISTRIBUTED_TABLE_SQL = f"""
CREATE TABLE IF NOT EXISTS {settings.CLICKHOUSE_LOGS_CLUSTER_DATABASE}.logs AS {settings.CLICKHOUSE_LOGS_CLUSTER_DATABASE}.{TABLE_NAME} ENGINE = Distributed('posthog', {settings.CLICKHOUSE_LOGS_CLUSTER_DATABASE}, '{TABLE_NAME}')
"""
